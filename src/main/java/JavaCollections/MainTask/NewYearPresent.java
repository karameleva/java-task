...
import static JavaCollections.MainTask.SweetsType.*;
import static JavaCollections.MainTask.FlourConfectionType.*;
public class NewYearPresent {
    ...
    public Map <FlourConfectionType, Integer> getFlourConfectionMap () {
        ...
        mapFlourConfection.put (BISCUITS, amountBiscuitsInPresent);
        mapFlourConfection.put (GINGERBREAD, amountGingerbreadInPresent);
