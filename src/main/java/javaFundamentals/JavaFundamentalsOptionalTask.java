...
// -----------------------------------------------------------------------
    ...
    public static void sort() {
        Integer[] array = inputArray();
        boolean swap = false;
        //до тех пор, пока мы не встретим первое число другой длины
...
//----------------------------------------------------------------------------------------------------------------
// 3. Вывести на консоль те числа, длина которых меньше (больше) средней длины по всем числам, а также их длину.
// ---------------------------------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------------------------------------
    ...
    public static void findEverAndOdd() {
        ...
        for (Integer elem : array) {
            int ever = 0; // чётные числа
            int odd = 0; // нечётные числа
